...
Each patrol iterates: find all road neighbors within radius R, move to the neighbor that most improves the global minimum spacing. Multiple restarts escape local optima. Key features:
